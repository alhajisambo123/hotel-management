...
const AboutPage = () => {
  ...
  succeed, Agenda is the bridge between support and success.
        ...
        <div className="grid md:grid-cols-2 gap-10 items-center">
          <div>
            ...
            <ul className="list-disc ml-5 text-base space-y-2">
              ...
              <li>
                Get academic help from peers who&rsquo;ve taken the same courses.
              </li>
        ...
        <div className="mt-12 bg-gray-100 p-6 rounded-xl shadow-inner">
          ...
          <p className="mb-4">
            Whether you&rsquo;re looking to tutor or be tutored, Agenda is here for
            you. Let&rsquo;s build a stronger academic community together at Legon.
          </p>
          <Link href="/auth">
